...
VETH2_MAC=$(cat /sys/class/net/${VETH2}/address)

ip netns exec ${NS1} ip neigh add ${VPEER_ADDR2} dev vpeer1 lladdr ${VETH1_MAC}
ip netns exec ${NS2} ip neigh add ${VPEER_ADDR1} dev vpeer2 lladdr ${VETH2_MAC}
